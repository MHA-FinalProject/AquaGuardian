...
public class FeatureNormalizer
{
    ...
    // computes mean and sample standard deviation (n-1) for each feature.
    ...
    // Normalize a single sample vector 
    ...
    // Inverse transform: convert normalized data back to original scale
    // X = Z * std + mean (inverse of Transform)
    ...
    // Inverse transform for a single normalized sample
